        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              {photo ? "Fotoattēls ielādēts" : "Pievieno vai uzņem attēlu"}
            </p>
          </div>
        </div>
        <input
      ...
      {photo && (
        <div className="bg-card rounded-xl p-6 border border-border shadow-sm">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              <h3 className="font-semibold text-card-foreground">Pielāgot foto</h3>
              <p className="text-sm text-muted-foreground">Velc, lai pārvietotu, ritini, lai tuvinātu</p>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <label className="text-sm font-medium text-card-foreground">Izmērs</label>
